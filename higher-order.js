...
let evenNumbers = mixedNumbers.filter(function (nums){
  return nums % 2 === 0;
})
...
//Code Here
let totalPopulation = populations.reduce(function (total, values){
  return total + values;
})
...
//Code Here
let myStrongest = monstersInYourPocket.map(function (){
...
let bobsTotal = purchases.reduce(function (total) {
